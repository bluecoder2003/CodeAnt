            ...
            <div className="w-full flex flex-row">
              {['SAAS', 'Self Hosted'].map((option) => (
                <button
                  ...
                  className={cn(
                    'p-2 md:px-4 md:py-3 w-full transition-colors rounded-lg',
            ...
            <div className="gap-3 justify-center items-center flex flex-col">
              {authButtonsData[selectedOption].map(({ icon, text, provider }) => (
                <button
                  key={provider}
                  className={cn(
                    'w-full md:w-3/4 flex items-center justify-center gap-2 p-3',
                    'border border-strokeColor rounded-lg hover:bg-gray-50 transition-colors'
                  )}
